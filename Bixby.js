...
╰───────────────`,
	    ...
	    case 'ytmp3': case 'getmusic': case 'ytaudio': {
                ...
                GojoMdNx.sendMessage(from, { text: `${pushname} UPLOADING YOUR SONG PLEASE WAIT...` }, { quoted: m })
            ...
            case 'ytmp4': case 'dgvideo': case 'ytvideo': {
                ...
                if (media.filesize >= 999999) return reply('File Over Limit '+util.format(media))
                GojoMdNx.sendMessage(from, { text: `${pushname} UPLOADING YOUR VIDEO PLEASE WAIT...` }, { quoted: m })
...
☕. ${prefix}" - ගීත ලබාගැනීමට Youtube Link ලබාදෙන්න. (320kbps)
...
break
	    ...
	    case 'alive': case 'bot':{
                                 message = await prepareWAMessageMedia({ image : { url: 'https://i.ibb.co/dkyCS0Y/ttg.jpg'} }, { upload:   GojoMdNx.waUploadToServer })
                                  template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                                      templateMessage: {
                                          hydratedTemplate: {
                                              imageMessage: message.imageMessage,
                                              hydratedContentText: "     QUEEN BIXBY-MD EDITION WA BOT\n\n🛢️ HAY THERE YOUR BOT IS ALIVE 🛢️ \n️\n💻. DEVELOPER : DARK ALPHA \n💻. HOSTED ON : HEROKU \n💻. VERSION :2022 July STdL\n💻. TEAM : DARK ALPHA-X TEAM\n💻. BASED BOT : GOJO SATORU\n\nBIXBY-MD IS AN MODIFIED VERSION OF THE GOJOSENSEI BOT .THANK FOR USING QUEEN BIXBY  MD.THIS IS MULTIFUNCTIONAL WHATSAPP BOT . SO DONT USE BOT FOR BAD THINGS\n\nSPECIAL COMMANDS\n🔏.alive : Is Bot Online\n🔏.menu : Get Command List\n🔏.song : download songs\n🔏.yts : get results for youtube\n🔏.video : download video\n\n📱 THANKS FOR USING QUEEN BIXBY ",
