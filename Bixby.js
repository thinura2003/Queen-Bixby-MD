...
🔗.  *Media Url* : ${images}`,
	    ...
	    case 'play': case 'song': case 'yt': {
                ...
                let buttons = [
                    {buttonId: `fsong ${search.all[0].url}`, buttonText: {displayText: 'HIGH QUALITY'}, type: 1},
                    {buttonId: `ytsmp3  ${search.all[0].url}`, buttonText: {displayText: 'MEDIUM QUALITY️'}, type: 1},
                    {buttonId: `podimp3  ${search.all[0].url}`, buttonText: {displayText: 'LOW QUALITY️'}, type: 1}
                ]
                let buttonMessage = {
...
╰───────────────`,
            ...
            break
	    case 'ytsmp3': case 'getmusic': case 'ytaudio': {
