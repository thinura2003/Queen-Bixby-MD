...
╰───────────────`,
	    ...
	    case 'ytmp3': case 'getmusic': case 'ytaudio': {
                ...
                GojoMdNx.sendMessage(from, { text: `${pushname} UPLOADING YOUR SONG` }, { quoted: m })
            ...
            case 'ytmp4': case 'dgvideo': case 'ytvideo': {
                ...
                if (media.filesize >= 999999) return reply('File Over Limit '+util.format(media))
                GojoMdNx.sendMessage(from, { text: `${pushname} UPLOADING YOUR VI` }, { quoted: m })
            ...
            case 'dvideo':{
                ...
                let media = await ytv(text, quality)
                if (media.filesize >= 999999) return reply('File Over Limit '+util.format(media))
                GojoMdNx.sendMessage(from, { text: `${pushname} UPLOADING YOUR VIDEO` }, { quoted: m })
