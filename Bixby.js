...
Jsl-Abu = tod.result.photo_profile
teks = `
▢ ᴜsᴇʀ ɴᴀᴍᴇ :  ${tod.result.username}
▢ ғᴜʟʟ ɴᴀᴍᴇ : ${tod.result.fullname}
▢ ғᴏʟʟᴏᴡᴇʀs : ${tod.result.followers}
▢ ғᴏʟʟᴏᴡɪɴɢ : ${tod.result.following}
▢ ᴛᴏᴛᴀʟ ᴘᴏsᴛ : ${tod.result.posts}
▢ ʙɪᴏ : ${tod.result.bio}
`
var yaha = await getBuffer(Jsl-Abu)
GojoMdNx.sendMessage(m.chat, { image: yaha, jpegThumbnail:yaha, caption: `${teks}` }, { quoted: m }).catch((err) => m.reply('*Username Not found*'))
}
break
